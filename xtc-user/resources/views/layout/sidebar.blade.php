<nav class="sidebar">
  <div class="sidebar-header">
    <a href="#" style="color:rgb(0, 255, 213)" class="sidebar-brand">
      XTC
    </a>
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['/panel']) }}">
        <a href="{{ url('/panel/home') }}" class="nav-link">
      ...
      <li class="nav-item {{ active_class(['/tickets']) }}">
        <a href="{{ url('/tickets/create') }}" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">Create ticket</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/tickets']) }}">
        <a href="{{ url('/tickets/') }}" class="nav-link">
          <i class="link-icon" data-feather="flag"></i>
          <span class="link-title">View tickets</span>
        </a>
      </li>

...
Route::group(['prefix' => '/'], function(){
    ...
    Route::get('changepassword', function(Request $request){
        ...
        return view('pages.auth.changepassword', ['username' => $username]);
    });
    ...
    Route::get('logs', function (Request $request) {
        return DashboardController::viewLogs($request);
    });

    Route::get('products', function (Request $request) {
        return DashboardController::products($request);
    });

    Route::group(['prefix' => 'tickets'], function(){
        Route::get('/', function (Request $request) {
            return TicketController::viewAll($request);
        });

        Route::get('/detail', function (Request $request) {
            return TicketController::detail($request);
        });

        Route::post('/answer', function (Request $request){
            return TicketController::answer($request);
        });

        Route::get('/close', function (Request $request) {
            return TicketController::close($request);
        });
    ...
    Route::group(['prefix' => 'admins'], function(){
        Route::get('/', function (Request $request) {
            return AdminController::viewAll($request);
        });

        Route::get('/detail', function (Request $request) {
            return AdminController::view($request);
        });

        Route::post('/edit', function (Request $request) {
            return AdminController::storeEdit($request);
        });

        Route::get('/resetpasswordcount', function(Request $request){
            return AdminController::resetPasswordCount($request);
        });
    });

    Route::group(['prefix' => 'licenses'], function(){
        Route::get('/', function (Request $request) {
            return DashboardController::licenses($request);
        });

        Route::get('/detail', function (Request $request){
            return LicenseController::viewDetail($request);
        });

        Route::get('/add', function (Request $request){
            return LicenseController::addLicense($request);
        });

        Route::post('/edit', function (Request $request){
            return LicenseController::storeEditLicense($request);
        });

        Route::get('/delete', function (Request $request){
            return LicenseController::deleteLicense($request);
        });
    });
    ...
    Route::group(['prefix' => 'users'], function(){
        Route::get('/', function (Request $request) {
            return DashboardController::users($request);
        });

        Route::get('/detail', function (Request $request){
            return DashboardController::userDetail($request);
        });

        Route::get('/ban', function (Request $request){
            return UserController::ban($request);
        });

        Route::get('/unban', function (Request $request){
            return UserController::unBan($request);
        });

        Route::get('/setHWID', function (Request $request){
            return UserController::setHWID($request);
        });

        Route::post('/edit', function (Request $request){
            return UserController::editUser($request);
        });
    });
});
